...
- Five of eight missing Physics markscheme screenshots were visually verified on public R2 and linked in `data/physics/processed/questions.json`, with nine corresponding PNGs added to Git. `phys_n24_p2_ntz_q10_sl` was a phantom record (empty question text, no marks, and the source markscheme has only Q1–Q6) and was removed. The two real remaining cases, `phys_m17_p3_tz2_q13_hl` and `phys_m17_p3_tz2_q9_sl`, have clean crops from their source PDFs committed under `data/physics/processed/images/markschemes/`, but their JSON links must wait until the PNGs are uploaded to public R2. The current R2 candidate for Q13 is blank, and other candidate files show adjacent questions; overwrite the base filename for Q13 and upload the base filename for Q9.
