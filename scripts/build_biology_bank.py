...
MANUAL = ROOT / "data" / "biology" / "processed" / "manual_papers.json"
OUT = ROOT / "data" / "biology" / "processed" / "questions.json"
IMAGES_ROOT = ROOT / "data" / "biology" / "processed" / "images"
...
def infer_topic(question_text: str, paper_code: str) -> tuple[str, str, float, List[str]]:
    # New IB Biology curriculum (first examined May 2025 – applies to 2027 exams).
    # Themes A/B/C/D; sections A1–A4, B1–B4, C1–C4, D1–D4.
    t = clean_text_for_topic(question_text)
    rules = [
        # Theme A: Unity and Diversity
        (
            ["water", "hydrogen bond", "cohesion", "adhesion", "specific heat", "solvent", "nucleic acid", "dna structure", "rna structure", "nucleotide", "base pairing", "double helix"],
            "A: Unity and Diversity",
            "A1 Water and nucleic acids",
        ),
        (
            ["origin of cell", "prokaryote", "eukaryote", "cell structure", "organelle", "mitochondria", "chloroplast", "ribosome", "nucleus", "endoplasmic reticulum", "golgi", "virus", "bacteriophage", "capsid", "lytic", "lysogenic"],
            "A: Unity and Diversity",
            "A2 Cell structure",
        ),
        (
            ["species", "kingdom", "phylum", "class", "order", "family", "genus", "taxonomy", "binomial nomenclature", "clade", "cladogram", "phylogenetic", "dichotomous key", "morphology"],
            "A: Unity and Diversity",
            "A3 Diversity of organisms",
        ),
        (
            ["population", "community", "biodiversity", "conservation", "endangered", "extinction", "invasive species", "habitat loss", "sampling", "quadrat", "transect", "simpsons index"],
            "A: Unity and Diversity",
            "A4 Conservation of biodiversity",
        ),
        # Theme B: Form and Function
        (
            ["carbohydrate", "monosaccharide", "glucose", "polysaccharide", "starch", "glycogen", "cellulose", "lipid", "fatty acid", "triglyceride", "phospholipid", "saturated", "unsaturated"],
            "B: Form and Function",
            "B1 Molecules",
        ),
        (
            ["protein", "amino acid", "peptide bond", "polypeptide", "primary structure", "secondary structure", "tertiary structure", "quaternary structure", "enzyme", "active site", "substrate", "induced fit"],
            "B: Form and Function",
            "B1 Molecules",
        ),
        (
            ["membrane", "fluid mosaic", "phospholipid bilayer", "osmosis", "diffusion", "active transport", "facilitated diffusion", "channel protein", "carrier protein", "endocytosis", "exocytosis", "compartmentalization", "vacuole", "lysosome"],
            "B: Form and Function",
            "B2 Membranes and organelles",
        ),
        (
            ["gas exchange", "alveolus", "lung", "trachea", "bronchus", "gill", "surface area to volume", "ventilation", "hemoglobin", "oxygen dissociation", "transport", "xylem", "phloem", "transpiration", "stomata", "muscle", "actin", "myosin", "sarcomere", "sliding filament"],
            "B: Form and Function",
            "B3 Movement",
        ),
        (
            ["adaptation", "natural selection", "selective advantage", "ecological niche", "resource partitioning", "competitive exclusion", "niche breadth"],
            "B: Form and Function",
            "B4 Ecology and adaptation",
        ),
        # Theme C: Interaction and Interdependence
        (
            ["enzyme kinetics", "activation energy", "substrate concentration", "inhibitor", "competitive inhibition", "non-competitive inhibition", "cofactor", "coenzyme", "metabolic pathway", "anabolism", "catabolism", "atp", "cell respiration", "glycolysis", "krebs cycle", "electron transport chain", "fermentation", "anaerobic", "aerobic", "photosynthesis", "light reaction", "calvin cycle", "chlorophyll", "light dependent", "light independent"],
            "C: Interaction and Interdependence",
            "C1 Metabolism",
        ),
        (
            ["hormone", "endocrine", "insulin", "glucagon", "adrenaline", "estrogen", "testosterone", "receptor", "signal transduction", "target cell", "neuron", "synapse", "action potential", "resting potential", "depolarization", "neurotransmitter", "reflex arc", "nervous system", "brain", "spinal cord"],
            "C: Interaction and Interdependence",
            "C2 Signaling",
        ),
        (
            ["digestion", "stomach", "intestine", "liver", "pancreas", "absorption", "circulatory", "heart", "blood", "cardiac", "immune", "antibody", "antigen", "lymphocyte", "b cell", "t cell", "vaccination", "pathogen", "inflammation", "homeostasis", "negative feedback", "thermoregulation", "kidney", "osmoregulation"],
            "C: Interaction and Interdependence",
            "C3 Integration of body systems",
        ),
        (
            ["ecosystem", "food chain", "food web", "producer", "consumer", "decomposer", "trophic level", "energy flow", "biomass", "carbon cycle", "nitrogen cycle", "nutrient cycle", "succession", "climax community", "sustainability", "greenhouse effect", "global warming", "recycling"],
            "C: Interaction and Interdependence",
            "C4 Ecosystems",
        ),
        # Theme D: Continuity and Change
        (
            ["dna replication", "helicase", "dna polymerase", "leading strand", "lagging strand", "okazaki fragment", "semi-conservative", "protein synthesis", "transcription", "translation", "mrna", "trna", "codon", "anticodon", "ribosome", "gene expression", "mutation", "mutagen", "crispr", "gene editing", "point mutation", "frameshift"],
            "D: Continuity and Change",
            "D1 DNA and proteins",
        ),
        (
            ["mitosis", "meiosis", "cell cycle", "interphase", "prophase", "metaphase", "anaphase", "telophase", "cytokinesis", "chromosome", "chromatid", "crossing over", "independent assortment", "epigenetics", "gene regulation", "operon", "water potential", "turgor", "plasmolysis"],
            "D: Continuity and Change",
            "D2 Cell continuity",
        ),
        (
            ["reproduction", "sexual reproduction", "asexual reproduction", "fertilization", "gamete", "meiosis", "menstrual cycle", "embryo", "germination", "seed", "inheritance", "allele", "genotype", "phenotype", "dominant", "recessive", "codominance", "sex-linked", "pedigree", "dihybrid cross", "punnett square", "chi squared"],
            "D: Continuity and Change",
            "D3 Reproduction and inheritance",
        ),
        (
            ["natural selection", "evolution", "speciation", "gene pool", "allele frequency", "hardy-weinberg", "genetic drift", "founder effect", "bottleneck", "phylogeny", "cladistics", "common ancestor", "divergent evolution", "convergent evolution"],
            "D: Continuity and Change",
            "D4 Evolution",
        ),
    ]
    ...
    if paper_no == 3:
        return ("C: Interaction and Interdependence", "C3 Integration of body systems", 0.2, ["paper 3 fallback"])
    if paper_no == 2:
        return ("C: Interaction and Interdependence", "C4 Ecosystems", 0.2, ["paper 2 fallback"])
...
def is_blank_answer_page(page: fitz.Page, clip: fitz.Rect) -> bool:
    ...
    if len(alpha) < 16:
        return True
    # Strip IB exam codes (e.g. m16/4/biolo/hp2/eng/tz0/xx), page numbers, and
...
def crop_question(
    ...
    for pno in range(s.page, last_page + 1):
        ...
        out.append(out_file.relative_to(ROOT / "data" / "biology" / "processed").as_posix())
...
def main() -> None:
    ...
    for p in papers:
        ...
        for qn in qnums:
            base = f"bio_{session_code}_p{str(p['paperCode']).lower()}_{str(p['timezone']).lower()}_q{qn}_{str(p['level']).lower()}"
    ...
    print(f"Wrote {len(questions)} biology questions -> {OUT}")
